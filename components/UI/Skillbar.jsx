        ...
        return (
            <div className='pt-2 pb-2'>
                ...
                <span className='text-white'>HTML/CSS</span>
                    ...
                    <div className="progress">
                        <div className="progress-bar" role="progressbar" style={{width: "88%"}} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">88%</div>
                    </div>
                     {/**------------------------------------- */}
                    ...
                    <div className="progress">
                        <div className="progress-bar" role="progressbar" style={{width: "98%"}} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">98%</div>
                    </div>
                     {/**------------------------------------- */}
